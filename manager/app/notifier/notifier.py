...
def check_notifications():
    ...
    with sqlite3.connect(DB_PATH) as conn:
        ...
        for project, organization, upload_ts in results:
            ...
            if current_time - upload_time > time_limit:
                print(f"Organization {organization} didn't send a file for project {project} in the last {MINIMUM_TIME_FOR_NOTIFICATION}. Last file sent in {upload_time}")
            else:
